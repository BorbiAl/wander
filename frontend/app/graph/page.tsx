...
export default function GraphPage() {
	...
	return (
		<main className="min-h-screen bg-[#E5E9DF] px-6 py-10 lg:px-12">
			<section className="mx-auto w-full max-w-6xl">
				<div className="mb-8">
					<h1 className="font-display text-4xl tracking-tight text-[#1A2E1C] lg:text-5xl">Your Travel Graph</h1>
				...
				<div className="grid gap-6 lg:grid-cols-[420px_1fr]">
					<div className="rounded-3xl border border-black/5 bg-white/70 p-6 shadow-sm">
						...
						<div className="flex justify-center">
							<PersonalityRadar vector={vector} size={320} />
						</div>
