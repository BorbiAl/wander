...
export default function ImpactPage() {
  ...
  if (bookings.length === 0) {
    return (
      <motion.div 
        ...
        className="min-h-screen bg-[#E5E9DF] flex flex-col items-center justify-center px-5 text-center font-sans"
      >
        <div className="mb-5 text-6xl drop-shadow-sm">🌍</div>
        <h2 className="mb-3 text-3xl sm:text-4xl font-bold tracking-tight text-[#1A2E1C]">No impact yet</h2>
        <p className="text-[#1A2E1C]/60 mb-8 max-w-sm text-base sm:text-lg font-medium">Book an experience to start seeing your direct village impact right here.</p>
        <button 
          onClick={() => router.push('/discover')}
          className="w-full max-w-xs rounded-full bg-[#0B6E2A] px-7 py-3 text-[15px] font-semibold tracking-wide text-white transition-all hover:bg-[#095A22] hover:scale-105 hover:shadow-lg active:scale-95"
        >
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-5xl px-4 py-6 sm:px-6 sm:py-10 lg:px-10 lg:py-14">
        
        {/* Header */}
        <div className="mb-8 sm:mb-10 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end">
          <div>
            <h1 className="text-[34px] sm:text-[50px] lg:text-[56px] leading-[1.1] font-bold tracking-[-0.04em] text-[#1A2E1C]">
              Impact
            </h1>
            <p className="text-[#1A2E1C]/60 text-base sm:text-xl font-medium tracking-tight mt-1">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5 mb-8 sm:mb-10">
          {[
            ...
            <div key={i} className="flex flex-col justify-end p-4 sm:p-5 rounded-[24px] sm:rounded-[28px] bg-white/60 backdrop-blur-md border border-white/50 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.05)] transition-transform hover:scale-[1.02]">
              <div className="text-[12px] font-semibold uppercase tracking-widest text-[#1A2E1C]/50 mb-2">
                {stat.label}
              </div>
              <div className={`text-3xl sm:text-5xl font-bold tracking-tighter ${stat.color}`}>
                {stat.value}
              </div>
            </div>
          ))}
        ...
        {liveImpacts.length > 0 && (
          <div className="mb-8 sm:mb-10 rounded-[24px] sm:rounded-[32px] bg-white/40 backdrop-blur-xl border border-white/40 shadow-sm p-5 sm:p-8">
            ...
            <div className="flex max-h-[180px] flex-col gap-3 overflow-y-auto pr-2 custom-scrollbar">
              {liveImpacts.map((evt) => (
        ...
        <div className="mb-8 sm:mb-10">
          <h2 className="text-2xl sm:text-3xl font-bold tracking-[-0.02em] text-[#1A2E1C] mb-4 sm:mb-6 pl-1 sm:pl-2">Booking Flow</h2>
          <div className="rounded-[24px] sm:rounded-[32px] bg-white/60 backdrop-blur-xl border border-white/40 shadow-sm p-5 sm:p-10">
            ...
            <p className="mt-6 sm:mt-8 text-center text-[14px] sm:text-[15px] font-medium tracking-tight text-[#6B7280]">
        ...
        {/* Two Column Layout */}
        <div className="mb-8 sm:mb-10 grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-8">
          {/* CWS Impact */}
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold tracking-[-0.02em] text-[#1A2E1C] mb-4 sm:mb-6 pl-1 sm:pl-2">CWS Impact</h2>
          ...
          {/* Over Time Chart */}
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold tracking-[-0.02em] text-[#1A2E1C] mb-4 sm:mb-6 pl-1 sm:pl-2">Impact Over Time</h2>
            <div className="h-[260px] sm:h-[350px] rounded-[24px] sm:rounded-[32px] bg-white/60 backdrop-blur-xl border border-white/40 shadow-sm p-4 sm:p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-8">
          <div className="rounded-[24px] sm:rounded-[32px] bg-white/60 backdrop-blur-xl border border-white/40 shadow-sm p-5 sm:p-8">
